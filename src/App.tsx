      ...
      <EditorWrapper
        ...
        alignments={[
          ...
          },
          {
            ...
            text2: 'nvi',
            links: [
              { text1: ['sbl_0'], text2: ['nvi_1'] },
              { text1: ['sbl_1'], text2: ['nvi_2'] },
              { text1: ['sbl_2'], text2: ['nvi_0'] },
              { text1: ['sbl_3'], text2: ['nvi_5'] },
              { text1: ['sbl_4'], text2: ['nvi_6'] },
              { text1: ['sbl_6'], text2: ['nvi_7'] },
              { text1: ['sbl_7', 'sbl_8'], text2: ['nvi_8', 'nvi_9'] },
              { text1: ['sbl_9'], text2: ['nvi_11'] },
              { text1: ['sbl_10'], text2: ['nvi_12'] },
              { text1: ['sbl_11'], text2: ['nvi_13'] },
              { text1: ['sbl_12'], text2: ['nvi_14'] },
              { text1: ['sbl_13'], text2: ['nvi_16'] },
              { text1: ['sbl_14'], text2: ['nvi_15'] },
            ],
          },
        ]}
      />
